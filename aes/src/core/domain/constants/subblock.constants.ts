...
export const STATUS_TRANSITIONS: Partial<Record<SubBlockStatus, SubBlockStatus[]>> = {
  // فاز تعریف
  'DEFINED': ['SUB_BLOCKED'],
  'SUB_BLOCKED': ['SAMPLING_REQUESTED'],
  
  // فاز نمونه‌برداری
  'SAMPLING_REQUESTED': ['SAMPLING_SCHEDULED', 'DEFINED'],
  'SAMPLING_SCHEDULED': ['SAMPLING_IN_PROGRESS', 'SAMPLING_REQUESTED'],
  'SAMPLING_IN_PROGRESS': ['SAMPLING_COMPLETED', 'SAMPLING_SCHEDULED'],
  'SAMPLING_COMPLETED': ['LAB_SENT'],
  
  // فاز آزمایشگاه
  'LAB_SENT': ['LAB_IN_PROGRESS'],
  'LAB_IN_PROGRESS': ['LAB_COMPLETED'],
  'LAB_COMPLETED': ['CLASSIFICATION_PENDING'],
  
  // فاز طبقه‌بندی
  'CLASSIFICATION_PENDING': ['CLASSIFICATION_DONE'],
  'CLASSIFICATION_DONE': ['DESTINATION_PENDING'],
  
  // فاز تصمیم‌گیری
  'DESTINATION_PENDING': ['DESTINATION_APPROVED'],
  'DESTINATION_APPROVED': ['LOADING_IN_PROGRESS'],
  
  // فاز اجرا
  'LOADING_IN_PROGRESS': ['LOADING_COMPLETED'],
  'LOADING_COMPLETED': ['TRANSPORTING'],
  'TRANSPORTING': ['DELIVERED'],
  'DELIVERED': ['PROCESSING'],
  
  // فاز فرآوری
  'PROCESSING': ['BENEFICIATION'],
  'BENEFICIATION': ['SIZING'],
  'SIZING': ['FINAL_PRODUCT'],
