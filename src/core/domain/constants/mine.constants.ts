...
export const DESTINATION_TYPES = {
  CRUSHER_LINE_1: 'CRUSHER_LINE_1',
  CRUSHER_LINE_2: 'CRUSHER_LINE_2',
  ...
  BENEFICIATION_PLANT: 'BENEFICIATION_PLANT',
  SIZING_PLANT: 'SIZING_PLANT',
  EXPORT: 'EXPORT',
} as const;

export const DESTINATION_LABELS: Record<DestinationType, string> = {
  'CRUSHER_LINE_1': 'خوراک خط ۱ خردایش (سنگ‌شکن فکی)',
  'CRUSHER_LINE_2': 'خوراک خط ۲ خردایش (سنگ‌شکن هیدروکن)',
  'CRUSHER_FEED': 'خوراک مستقیم مدار خردایش',
  'HIGH_GRADE_STOCKPILE': 'دپوی سنگ پرعیار (High Grade)',
  'MEDIUM_GRADE_STOCKPILE': 'دپوی عیار متوسط (Medium Grade)',
  'LOW_GRADE_STOCKPILE': 'دپوی عیار پایین (Low Grade)',
  'BLEND_STOCKPILE': 'دپوی اختلاط و همگن‌سازی',
  'WASTE_DUMP_ROCK': 'دامپ باطله سنگی',
  'WASTE_DUMP_ALLUVIAL': 'دامپ باطله آبرفتی',
  'TEMPORARY_STOCKPILE': 'دپوی موقت جبهه‌کار',
  'BENEFICIATION_PLANT': 'کارخانه پرعیارسازی',
  'SIZING_PLANT': 'واحد دانه‌بندی و سرند',
  'EXPORT': 'صادرات / فروش مستقیم',
};
